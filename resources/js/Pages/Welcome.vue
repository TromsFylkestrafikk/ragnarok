...
<template>
  ...
  <div class="tw-relative sm:tw-flex sm:tw-justify-center sm:tw-items-center tw-min-h-screen bg-dots-darker tw-bg-center tw-bg-gray-100 dark:bg-dots-lighter dark:tw-bg-gray-900 selection:tw-bg-red-500 selection:tw-text-white">
    <div v-if="canLogin" class="sm:tw-fixed sm:tw-top-0 sm:tw-right-0 tw-p-6 tw-text-right">
      ...
      <template v-else>
        <Link
          :href="route('login')"
          class="tw-font-semibold tw-text-gray-600 hover:tw-text-gray-900 dark:tw-text-gray-400 dark:tw-hover:tw-text-white focus:tw-outline focus:tw-outline-2 focus:tw-rounded-sm focus:tw-outline-red-500"
        >
          Log in
        </Link>
    ...
    <div class="tw-max-w-7xl tw-mx-auto tw-p-6 lg:tw-p-8">
      ...
      <div class="tw-mt-16">
        <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-6 lg:tw-gap-8">
          <a
            ...
            class="tw-scale-100 tw-p-6 tw-bg-white dark:tw-bg-gray-800/50 dark:tw-bg-gradient-to-bl tw-from-gray-700/50 tw-via-transparent dark:tw-ring-1 dark:tw-ring-inset dark:tw-ring-white/5 tw-rounded-lg tw-shadow-2xl tw-shadow-gray-500/20 dark:tw-shadow-none tw-flex motion-safe:hover:tw-scale-[1.01] tw-transition-all tw-duration-250 focus:tw-outline focus:tw-outline-2 focus:tw-outline-red-500"
          >
            <div>
              <div class="tw-h-16 tw-w-16 tw-bg-red-50 dark:tw-bg-red-800/20 tw-flex tw-items-center tw-justify-center tw-rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
                  class="tw-w-7 tw-h-7 tw-stroke-red-500"
                >
                  <path
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              stroke-width="1.5"
              class="tw-self-center tw-shrink-0 tw-stroke-red-500 tw-w-6 tw-h-6 tw-mx-6"
            >
          ...
          <div class="tw-scale-100 tw-p-6 tw-bg-white dark:tw-bg-gray-800/50 dark:tw-bg-gradient-to-bl tw-from-gray-700/50 tw-via-transparent dark:tw-ring-1 dark:tw-ring-inset dark:tw-ring-white/5 tw-rounded-lg tw-shadow-2xl tw-shadow-gray-500/20 dark:tw-shadow-none tw-flex motion-safe:hover:tw-scale-[1.01] tw-transition-all tw-duration-250 focus:tw-outline focus:tw-outline-2 focus:tw-outline-red-500">
            <div>
              <div class="tw-h-16 tw-w-16 tw-bg-red-50 dark:tw-bg-red-800/20 tw-flex tw-items-center tw-justify-center tw-rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="tw-flex tw-justify-center tw-mt-16 tw-px-6 sm:tw-items-center sm:tw-justify-between">
        <div class="tw-text-center tw-text-sm tw-text-gray-500 dark:tw-text-gray-400 sm:tw-text-left">
          <div class="tw-flex tw-items-center tw-gap-4">
            <a
              ...
              class="tw-group tw-inline-flex tw-items-center hover:tw-text-gray-700 dark:hover:tw-text-white focus:tw-outline focus:tw-outline-2 focus:tw-rounded-sm focus:tw-outline-red-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="1.5"
                class="-tw-mt-px tw-mr-1 tw-w-5 tw-h-5 tw-stroke-gray-400 dark:tw-stroke-gray-600 group-hover:tw-stroke-gray-600 dark:group-hover:tw-stroke-gray-400"
              >
        ...
        <div class="tw-ml-4 tw-text-center tw-text-sm tw-text-gray-500 dark:tw-text-gray-400 sm:tw-text-right sm:tw-ml-0">
